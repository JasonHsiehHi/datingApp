            ...
            $.ajax({
                ...
                success:function(data) {
                    if (!0 === data['result']){
                        ...
                        // 可能導致還未全部通知 consumer就直接進行disconnect 必須像'START'一樣確保所有人都知道
                    }else{
                        $('#leave-modal-form p.a-error').text(data['msg']);
                    }
                },
