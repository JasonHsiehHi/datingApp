...
["問題X：如果只看暱稱，你認為<span class='a-point'>name1</span>是個怎麼樣的人？ (限時時間: 1min)", !1, "s"],
["問題X：如果只看暱稱，<span class='a-point'>name1</span>和<span class='a-point'>name2</span>掉到水裡，你會先救誰？ (限時時間: 1min)", !1, "s"],
